...
import { CardCoursestions } from '../Constants/CardCourses';

const AllCoursesContent = () => {
  return (
    <>
      {CardCoursestions.map((card, index) => (
        <div key={index} className="pb-3 relative w-full ">
            ...
            <div className="w-full h-full">
              ...
              <div className="p-6 bg-white flex flex-col gap-8 rounded-[10px] rounded-tl-none rounded-tr-none ">
                <div>
                  ...
                  <p className="text-[18px] font-bold h-[54px]">{card.title}</p>
                </div>
