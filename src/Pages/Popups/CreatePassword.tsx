      ...
      <div className="w-full h-full relative">
        ...
        <div className="PopUpsStyles">
          ...
          <div className="flex w-[328px] flex-col gap-4 justify-center text-center">
            <h1 className="main-title ">Create a password</h1>
          ...
          <div className="flex flex-col gap-4 mt-16">
            ...
            <div>
              <label className="main-label ">Enter your password again</label>
              <div className="flex items-center relative ">
                <div className="icon-Input">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex w-[328px] items-center gap-2 my-16 justify-center">
            <Link to={'/welcome'} className="styleBtnSecon">
              Go back
            </Link>
            <Link to={'/terms'} className="styleBtnPrimary">
              Continue
            </Link>
          </div>
        </div>
